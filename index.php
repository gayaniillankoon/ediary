...
<div class="container">
  ...
  <div class="col-sm-4">
   ...
   <div class="row"> 
    ...
    <form method="post" action="log_pros.php"  >
...
<div class="row" >
      ...
      <h6><b>You want to keep your thoughts in a place where no one can find them? Dear eDiary offers you a safe place for your very personal topics.</b></h6>     </div>
      </div>
      <div class="col-md-3">
      <div class="costomDiv" style="margin:40px;main-height:300px;text-align:center;font-size:large;color:black;">
      <br>
