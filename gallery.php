...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
  <ul class="navbar-nav">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="indexcal.php">My Gallery</a>
    </li>
    <li class="nav-item">
...
<div class="col-md-10">
  ...
  if(isset($_POST['submit'])){
    ...
    for($i = 0; $i<= count($tmpname)-1;$i++){
      ...
      mysql_query("INSERT into img(name,image,user)values('$name','$tmp','$user')");
    }
  }
 ?> 
</div>
...
<div class="row">
  ...
  while($row = mysql_fetch_array($res)){
    echo '<img src = "data:image/jpeg;base64,'.base64_encode($row['image']).'" width="240" height="200">';
  }
  ?>
  </div>
  <div class="col-md-1"></div>
